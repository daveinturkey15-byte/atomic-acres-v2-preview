...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xs(e,t,n){let r=new Float32Array(Is),i=new H(0,1,0);return new Ja({name:`SphericalGaussianBlur`,defines:{n:Is,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zs(){return new Ja({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qs(){return new Ja({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$s(),fragmentShader:`
	...
	`}var ec=class extends on{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Tl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function El(e,t){let n=Tl[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Dl=new H;function Ol(){return W.getLuminanceCoefficients(Dl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Dl.x.toFixed(4)}, ${Dl.y.toFixed(4)}, ${Dl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
s=-\r
t=0 0\r
`},n.getDirection=function(e,t){let r=n.splitLines(e);for(let e=0;e<r.length;e++)switch(r[e]){case`a=sendrecv`:case`a=sendonly`:case`a=recvonly`:case`a=inactive`:return r[e].substring(2);default:}return t?n.getDirection(t):`sendrecv`},n.getKind=function(e){return n.splitLines(e)[0].split(` `)[0].substring(2)},n.isRejected=function(e){return e.split(` `,2)[1]===`0`},n.parseMLine=function(e){let t=n.splitLines(e)[0].substring(2).split(` `);return{kind:t[0],port:parseInt(t[1],10),protocol:t[2],fmt:t.slice(3).join(` `)}},n.parseOLine=function(e){let t=n.matchPrefix(e,`o=`)[0].substring(2).split(` `);return{username:t[0],sessionId:t[1],sessionVersion:parseInt(t[2],10),netType:t[3],addressType:t[4],address:t[5]}},n.isValidSDP=function(e){if(typeof e!=`string`||e.length===0)return!1;let t=n.splitLines(e);for(let e=0;e<t.length;e++)if(t[e].length<2||t[e].charAt(1)!==`=`)return!1;return!0},typeof t==`object`&&(t.exports=n)})),Qf=s({removeExtmapAllowMixed:()=>ap,shimAddIceCandidateNullOrEmpty:()=>op,shimConnectionState:()=>ip,shimMaxMessageSize:()=>np,shimParameterlessSetLocalDescription:()=>sp,shimRTCIceCandidate:()=>ep,shimRTCIceCandidateRelayProtocol:()=>tp,shimSendThrowTypeError:()=>rp}),$f=l(Zf());function ep(e){if(!e.RTCIceCandidate||e.RTCIceCandidate&&`foundation`in e.RTCIceCandidate.prototype)return;let t=e.RTCIceCandidate;e.RTCIceCandidate=function(e){if(typeof e==`object`&&e.candidate&&e.candidate.indexOf(`a=`)===0&&(e=JSON.parse(JSON.stringify(e)),e.candidate=e.candidate.substring(2)),e.candidate&&e.candidate.length){let n=new t(e),r=$f.default.parseCandidate(e.candidate);for(let e in r)e in n||Object.defineProperty(n,e,{value:r[e]});return n.toJSON=function(){return{candidate:n.candidate,sdpMid:n.sdpMid,sdpMLineIndex:n.sdpMLineIndex,usernameFragment:n.usernameFragment}},n}return new t(e)},e.RTCIceCandidate.prototype=t.prototype,of(e,`icecandidate`,t=>(t.candidate&&Object.defineProperty(t,"candidate",{value:new e.RTCIceCandidate(t.candidate),writable:`false`}),t))}function tp(e){!e.RTCIceCandidate||e.RTCIceCandidate&&`relayProtocol`in e.RTCIceCandidate.prototype||of(e,`icecandidate`,e=>{if(e.candidate){let t=$f.default.parseCandidate(e.candidate.candidate);t.type===`relay`&&(e.candidate.relayProtocol={0:`tls`,1:`tcp`,2:`udp`}[t.priority>>24])}return e})}function np(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>102||t.browser===`firefox`&&t.version>=113)return;`sctp`in e.RTCPeerConnection.prototype||Object.defineProperty(e.RTCPeerConnection.prototype,"sctp",{get(){return this._sctp===void 0?null:this._sctp}});let n=function(e){if(!e||!e.sdp)return!1;let t=$f.default.splitSections(e.sdp);return t.shift(),t.some(e=>{let t=$f.default.parseMLine(e);return t&&t.kind===`application`&&t.protocol.indexOf(`SCTP`)!==-1})},r=function(e){let t=e.sdp.match(/mozilla...THIS_IS_SDPARTA-(\d+)/);if(t===null||t.length<2)return-1;let n=parseInt(t[1],10);return n===n?n:-1},i=function(e){let n=65536;return t.browser===`firefox`&&(n=t.version<57?e===-1?16384:2147483637:t.version<60?t.version===57?65535:65536:2147483637),n},a=function(e,n){let r=65536;t.browser===`firefox`&&t.version===57&&(r=65535);let i=$f.default.matchPrefix(e.sdp,`a=max-message-size:`);return i.length>0?r=parseInt(i[0].substring(19),10):t.browser===`firefox`&&n!==-1&&(r=2147483637),r},o=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(){if(this._sctp=null,t.browser===`chrome`&&t.version>=76){let{sdpSemantics:e}=this.getConfiguration();e===`plan-b`&&Object.defineProperty(this,"sctp",{get(){return this._sctp===void 0?null:this._sctp},enumerable:!0,configurable:!0})}if(n(arguments[0])){let e=r(arguments[0]),t=i(e),n=a(arguments[0],e),o;o=t===0&&n===0?1/0:t===0||n===0?Math.max(t,n):Math.min(t,n);let s={};Object.defineProperty(s,"maxMessageSize",{get(){return o}}),this._sctp=s}return o.apply(this,arguments)}}function rp(e,t){if(!(e.RTCPeerConnection&&`createDataChannel`in e.RTCPeerConnection.prototype)||t.browser===`chrome`&&t.version>=149||t.browser===`firefox`&&t.version>60)return;function n(e,t){let n=e.send;e.send=function(){let r=arguments[0],i=r.length||r.size||r.byteLength;if(e.readyState===`open`&&t.sctp&&i>t.sctp.maxMessageSize)throw TypeError(`Message too large (can send a maximum of `+t.sctp.maxMessageSize+` bytes)`);return n.apply(e,arguments)}}let r=e.RTCPeerConnection.prototype.createDataChannel;e.RTCPeerConnection.prototype.createDataChannel=function(){let e=r.apply(this,arguments);return n(e,this),e},of(e,`datachannel`,e=>(n(e.channel,e.target),e))}function ip(e){if(!e.RTCPeerConnection||`connectionState`in e.RTCPeerConnection.prototype)return;let t=e.RTCPeerConnection.prototype;Object.defineProperty(t,"connectionState",{get(){return{completed:`connected`,checking:`connecting`}[this.iceConnectionState]||this.iceConnectionState},enumerable:!0,configurable:!0}),Object.defineProperty(t,"onconnectionstatechange",{get(){return this._onconnectionstatechange||null},set(e){this._onconnectionstatechange&&(this.removeEventListener(`connectionstatechange`,this._onconnectionstatechange),delete this._onconnectionstatechange),e&&this.addEventListener(`connectionstatechange`,this._onconnectionstatechange=e)},enumerable:!0,configurable:!0}),[`setLocalDescription`,`setRemoteDescription`].forEach(e=>{let n=t[e];t[e]=function(){return this._connectionstatechangepoly||(this._connectionstatechangepoly=e=>{let t=e.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;let n=new Event(`connectionstatechange`,e);t.dispatchEvent(n)}return e},this.addEventListener(`iceconnectionstatechange`,this._connectionstatechangepoly)),n.apply(this,arguments)}})}function ap(e,t){if(!e.RTCPeerConnection||t.browser===`chrome`&&t.version>=71||t.browser===`safari`&&t._safariVersion>=13.1)return;let n=e.RTCPeerConnection.prototype.setRemoteDescription;e.RTCPeerConnection.prototype.setRemoteDescription=function(t){if(t&&t.sdp&&t.sdp.indexOf(`
a=extmap-allow-mixed`)!==-1){let n=t.sdp.split(`
`).filter(e=>e.trim()!==`a=extmap-allow-mixed`).join(`
`);e.RTCSessionDescription&&t instanceof e.RTCSessionDescription?arguments[0]=new e.RTCSessionDescription({type:t.type,sdp:n}):t.sdp=n}return n.apply(this,arguments)}}function op(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.addIceCandidate;!n||n.length===0||(e.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?(t.browser===`chrome`&&t.version<78||t.browser===`firefox`&&t.version<68||t.browser===`safari`)&&arguments[0]&&arguments[0].candidate===``?Promise.resolve():n.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())})}function sp(e,t){if(!(e.RTCPeerConnection&&e.RTCPeerConnection.prototype))return;let n=e.RTCPeerConnection.prototype.setLocalDescription;!n||n.length===0||(e.RTCPeerConnection.prototype.setLocalDescription=function(){let e=arguments[0]||{};if(typeof e!=`object`||e.type&&e.sdp)return n.apply(this,arguments);if(e={type:e.type,sdp:e.sdp},!e.type)switch(this.signalingState){case`stable`:case`have-local-offer`:case`have-remote-pranswer`:e.type=`offer`;break;default:e.type=`answer`;break}return e.sdp||e.type!==`offer`&&e.type!==`answer`?n.apply(this,[e]):(e.type===`offer`?this.createOffer:this.createAnswer).apply(this).then(e=>n.apply(this,[e]))})}function cp({window:e}={},t={shimChrome:!0,shimFirefox:!0,shimSafari:!0}){let n=lf,r=df(e),i={browserDetails:r,commonShim:Qf,extractVersion:af,disableLog:sf,disableWarnings:cf,sdp:$f};switch(r.browser){case`chrome`:if(!vf||!Tf||!t.shimChrome)return n(`Chrome shim is not included in this adapter release.`),i;if(r.version===null)return n(`Chrome shim can not determine version, not shimming.`),i;n(`adapter.js shimming chrome.`),i.browserShim=vf,op(e,r),sp(e,r),_f(e,r),yf(e,r),Tf(e,r),bf(e,r),wf(e,r),xf(e,r),Sf(e,r),Ef(e,r),ep(e,r),tp(e,r),ip(e,r),np(e,r),rp(e,r),ap(e,r);break;case`firefox`:if(!kf||!jf||!t.shimFirefox)return n(`Firefox shim is not included in this adapter release.`),i;n(`adapter.js shimming firefox.`),i.browserShim=kf,op(e,r),sp(e,r),Df(e,r),jf(e,r),Mf(e,r),Af(e,r),Ff(e,r),Nf(e,r),Pf(e,r),If(e,r),Lf(e,r),Rf(e,r),zf(e,r),Bf(e,r),ep(e,r),ip(e,r),np(e,r),rp(e,r);break;case`safari`:if(!Vf||!t.shimSafari)return n(`Safari shim is not included in this adapter release.`),i;n(`adapter.js shimming safari.`),i.browserShim=Vf,op(e,r),sp(e,r),qf(e,r),Yf(e,r),Wf(e,r),Hf(e,r),Uf(e,r),Jf(e,r),Gf(e,r),Xf(e,r),ep(e,r),tp(e,r),np(e,r),rp(e,r),ap(e,r);break;default:n(`Unsupported browser!`);break}return i}var lp=cp({window:typeof window>`u`?void 0:window});function up(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var dp=class{constructor(){this.chunkedMTU=16300,this._dataCount=1,this.chunk=e=>{let t=[],n=e.byteLength,r=Math.ceil(n/this.chunkedMTU),i=0,a=0;for(;a<n;){let o=Math.min(n,a+this.chunkedMTU),s=e.slice(a,o),c={__peerData:this._dataCount,n:i,data:s,total:r};t.push(c),a=o,i++}return this._dataCount++,t}}};function fp(e){let t=0;for(let n of e)t+=n.byteLength;let n=new Uint8Array(t),r=0;for(let t of e)n.set(t,r),r+=t.byteLength;return n}var pp=lp.default||lp,mp=new class{isWebRTCSupported(){return typeof RTCPeerConnection<`u`}isBrowserSupported(){let e=this.getBrowser(),t=this.getVersion();return this.supportedBrowsers.includes(e)?e===`chrome`?t>=this.minChromeVersion:e===`firefox`?t>=this.minFirefoxVersion:e===`safari`?!this.isIOS&&t>=this.minSafariVersion:!1:!1}getBrowser(){return pp.browserDetails.browser}getVersion(){return pp.browserDetails.version||0}isUnifiedPlanSupported(){let e=this.getBrowser(),t=pp.browserDetails.version||0;if(e===`chrome`&&t<this.minChromeVersion)return!1;if(e===`firefox`&&t>=this.minFirefoxVersion)return!0;if(!window.RTCRtpTransceiver||!(`currentDirection`in RTCRtpTransceiver.prototype))return!1;let n,r=!1;try{n=new RTCPeerConnection,n.addTransceiver(`audio`),r=!0}catch{}finally{n&&n.close()}return r}toString(){return`Supports:
    browser:${this.getBrowser()}
    version:${this.getVersion()}
    isIOS:${this.isIOS}
    isWebRTCSupported:${this.isWebRTCSupported()}
    isBrowserSupported:${this.isBrowserSupported()}
    isUnifiedPlanSupported:${this.isUnifiedPlanSupported()}`}constructor(){this.isIOS=typeof navigator<`u`?[`iPad`,`iPhone`,`iPod`].includes(navigator.platform):!1,this.supportedBrowsers=[`firefox`,`chrome`,`safari`],this.minFirefoxVersion=59,this.minChromeVersion=72,this.minSafariVersion=605}},hp=e=>!e||/^[A-Za-z0-9]+(?:[ _-][A-Za-z0-9]+)*$/.test(e),gp=()=>Math.random().toString(36).slice(2),_p={iceServers:[{urls:`stun:stun.l.google.com:19302`},{urls:[`turn:eu-0.turn.peerjs.com:3478`,`turn:us-0.turn.peerjs.com:3478`],username:`peerjs`,credential:`peerjsp`}],sdpSemantics:`unified-plan`},vp=new class extends dp{noop(){}blobToArrayBuffer(e,t){let n=new FileReader;return n.onload=function(e){e.target&&t(e.target.result)},n.readAsArrayBuffer(e),n}binaryStringToArrayBuffer(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n)&255;return t.buffer}isSecure(){return location.protocol===`https:`}constructor(...e){super(...e),this.CLOUD_HOST=`0.peerjs.com`,this.CLOUD_PORT=443,this.chunkedBrowsers={Chrome:1,chrome:1},this.defaultConfig=_p,this.browser=mp.getBrowser(),this.browserVersion=mp.getVersion(),this.pack=$d,this.unpack=Qd,this.supports=function(){let e={browser:mp.isBrowserSupported(),webRTC:mp.isWebRTCSupported(),audioVideo:!1,data:!1,binaryBlob:!1,reliable:!1};if(!e.webRTC)return e;let t;try{t=new RTCPeerConnection(_p),e.audioVideo=!0;let n;try{n=t.createDataChannel(`_PEERJSTEST`,{ordered:!0}),e.data=!0,e.reliable=!!n.ordered;try{n.binaryType=`blob`,e.binaryBlob=!mp.isIOS}catch{}}catch{}finally{n&&n.close()}}catch{}finally{t&&t.close()}return e}(),this.validateId=hp,this.randomToken=gp}},yp=`PeerJS: `,Z=new class{get logLevel(){return this._logLevel}set logLevel(e){this._logLevel=e}log(...e){this._logLevel>=3&&this._print(3,...e)}warn(...e){this._logLevel>=2&&this._print(2,...e)}error(...e){this._logLevel>=1&&this._print(1,...e)}setLogFunction(e){this._print=e}_print(e,...t){let n=[yp,...t];for(let e in n)n[e]instanceof Error&&(n[e]=`(`+n[e].name+`) `+n[e].message);e>=3?console.log(...n):e>=2?console.warn(`WARNING`,...n):e>=1&&console.error(`ERROR`,...n)}constructor(){this._logLevel=0}},bp={},xp=Object.prototype.hasOwnProperty,Sp=`~`;function Cp(){}Object.create&&(Cp.prototype=Object.create(null),new Cp().__proto__||(Sp=!1));function wp(e,t,n){this.fn=e,this.context=t,this.once=n||!1}function Tp(e,t,n,r,i){if(typeof n!=`function`)throw TypeError(`The listener must be a function`);var a=new wp(n,r||e,i),o=Sp?Sp+t:t;return e._events[o]?e._events[o].fn?e._events[o]=[e._events[o],a]:e._events[o].push(a):(e._events[o]=a,e._eventsCount++),e}function Ep(e,t){--e._eventsCount===0?e._events=new Cp:delete e._events[t]}function Dp(){this._events=new Cp,this._eventsCount=0}Dp.prototype.eventNames=function(){var e=[],t,n;if(this._eventsCount===0)return e;for(n in t=this._events)xp.call(t,n)&&e.push(Sp?n.slice(1):n);return Object.getOwnPropertySymbols?e.concat(Object.getOwnPropertySymbols(t)):e},Dp.prototype.listeners=function(e){var t=Sp?Sp+e:e,n=this._events[t];if(!n)return[];if(n.fn)return[n.fn];for(var r=0,i=n.length,a=Array(i);r<i;r++)a[r]=n[r].fn;return a},Dp.prototype.listenerCount=function(e){var t=Sp?Sp+e:e,n=this._events[t];return n?n.fn?1:n.length:0},Dp.prototype.emit=function(e,t,n,r,i,a){var o=Sp?Sp+e:e;if(!this._events[o])return!1;var s=this._events[o],c=arguments.length,l,u;if(s.fn){switch(s.once&&this.removeListener(e,s.fn,void 0,!0),c){case 1:return s.fn.call(s.context),!0;case 2:return s.fn.call(s.context,t),!0;case 3:return s.fn.call(s.context,t,n),!0;case 4:return s.fn.call(s.context,t,n,r),!0;case 5:return s.fn.call(s.context,t,n,r,i),!0;case 6:return s.fn.call(s.context,t,n,r,i,a),!0}for(u=1,l=Array(c-1);u<c;u++)l[u-1]=arguments[u];s.fn.apply(s.context,l)}else{var d=s.length,f;for(u=0;u<d;u++)switch(s[u].once&&this.removeListener(e,s[u].fn,void 0,!0),c){case 1:s[u].fn.call(s[u].context);break;case 2:s[u].fn.call(s[u].context,t);break;case 3:s[u].fn.call(s[u].context,t,n);break;case 4:s[u].fn.call(s[u].context,t,n,r);break;default:if(!l)for(f=1,l=Array(c-1);f<c;f++)l[f-1]=arguments[f];s[u].fn.apply(s[u].context,l)}}return!0},Dp.prototype.on=function(e,t,n){return Tp(this,e,t,n,!1)},Dp.prototype.once=function(e,t,n){return Tp(this,e,t,n,!0)},Dp.prototype.removeListener=function(e,t,n,r){var i=Sp?Sp+e:e;if(!this._events[i])return this;if(!t)return Ep(this,i),this;var a=this._events[i];if(a.fn)a.fn===t&&(!r||a.once)&&(!n||a.context===n)&&Ep(this,i);else{for(var o=0,s=[],c=a.length;o<c;o++)(a[o].fn!==t||r&&!a[o].once||n&&a[o].context!==n)&&s.push(a[o]);s.length?this._events[i]=s.length===1?s[0]:s:Ep(this,i)}return this},Dp.prototype.removeAllListeners=function(e){var t;return e?(t=Sp?Sp+e:e,this._events[t]&&Ep(this,t)):(this._events=new Cp,this._eventsCount=0),this},Dp.prototype.off=Dp.prototype.removeListener,Dp.prototype.addListener=Dp.prototype.on,Dp.prefixed=Sp,Dp.EventEmitter=Dp,bp=Dp;var Op={};up(Op,`ConnectionType`,()=>kp),up(Op,`PeerErrorType`,()=>Ap),up(Op,`BaseConnectionErrorType`,()=>jp),up(Op,`DataConnectionErrorType`,()=>Mp),up(Op,`SerializationType`,()=>Np),up(Op,`SocketEventType`,()=>Pp),up(Op,`ServerMessageType`,()=>Fp);var kp=function(e){return e.Data=`data`,e.Media=`media`,e}({}),Ap=function(e){return e.BrowserIncompatible=`browser-incompatible`,e.Disconnected=`disconnected`,e.InvalidID=`invalid-id`,e.InvalidKey=`invalid-key`,e.Network=`network`,e.PeerUnavailable=`peer-unavailable`,e.SslUnavailable=`ssl-unavailable`,e.ServerError=`server-error`,e.SocketError=`socket-error`,e.SocketClosed=`socket-closed`,e.UnavailableID=`unavailable-id`,e.WebRTC=`webrtc`,e}({}),jp=function(e){return e.NegotiationFailed=`negotiation-failed`,e.ConnectionClosed=`connection-closed`,e}({}),Mp=function(e){return e.NotOpenYet=`not-open-yet`,e.MessageToBig=`message-too-big`,e}({}),Np=function(e){return e.Binary=`binary`,e.BinaryUTF8=`binary-utf8`,e.JSON=`json`,e.None=`raw`,e}({}),Pp=function(e){return e.Message=`message`,e.Disconnected=`disconnected`,e.Error=`error`,e.Close=`close`,e}({}),Fp=function(e){return e.Heartbeat=`HEARTBEAT`,e.Candidate=`CANDIDATE`,e.Offer=`OFFER`,e.Answer=`ANSWER`,e.Open=`OPEN`,e.Error=`ERROR`,e.IdTaken=`ID-TAKEN`,e.InvalidKey=`INVALID-KEY`,e.Leave=`LEAVE`,e.Expire=`EXPIRE`,e}({}),Ip=`1.5.5`,Lp=class extends bp.EventEmitter{constructor(e,t,n,r,i,a=5e3){super(),this.pingInterval=a,this._disconnected=!0,this._messagesQueue=[];let o=e?`wss://`:`ws://`;this._baseUrl=o+t+`:`+n+r+`peerjs?key=`+i}start(e,t){this._id=e;let n=`${this._baseUrl}&id=${e}&token=${t}`;this._socket||!this._disconnected||(this._socket=new WebSocket(n+`&version=1.5.5`),this._disconnected=!1,this._socket.onmessage=e=>{let t;try{t=JSON.parse(e.data),Z.log(`Server message received:`,t)}catch{Z.log(`Invalid server message`,e.data);return}this.emit(Pp.Message,t)},this._socket.onclose=e=>{this._disconnected||(Z.log(`Socket closed.`,e),this._cleanup(),this._disconnected=!0,this.emit(Pp.Disconnected))},this._socket.onopen=()=>{this._disconnected||(this._sendQueuedMessages(),Z.log(`Socket open`),this._scheduleHeartbeat())})}_scheduleHeartbeat(){this._wsPingTimer=setTimeout(()=>{this._sendHeartbeat()},this.pingInterval)}_sendHeartbeat(){if(!this._wsOpen()){Z.log(`Cannot send heartbeat, because socket closed`);return}let e=JSON.stringify({type:Fp.Heartbeat});this._socket.send(e),this._scheduleHeartbeat()}_wsOpen(){return!!this._socket&&this._socket.readyState===1}_sendQueuedMessages(){let e=[...this._messagesQueue];this._messagesQueue=[];for(let t of e)this.send(t)}send(e){if(this._disconnected)return;if(!this._id){this._messagesQueue.push(e);return}if(!e.type){this.emit(Pp.Error,`Invalid message`);return}if(!this._wsOpen())return;let t=JSON.stringify(e);this._socket.send(t)}close(){this._disconnected||=(this._cleanup(),!0)}_cleanup(){this._socket&&=(this._socket.onopen=this._socket.onmessage=this._socket.onclose=null,this._socket.close(),void 0),clearTimeout(this._wsPingTimer)}},Rp=class{constructor(e){this.connection=e}startConnection(e){let t=this._startPeerConnection();if(this.connection.peerConnection=t,this.connection.type===kp.Media&&e._stream&&this._addTracksToConnection(e._stream,t),e.originator){let n=this.connection,r={ordered:!!e.reliable},i=t.createDataChannel(n.label,r);n._initializeDataChannel(i),this._makeOffer()}else this.handleSDP(`OFFER`,e.sdp)}_startPeerConnection(){Z.log(`Creating RTCPeerConnection.`);let e=new RTCPeerConnection(this.connection.provider.options.config);return this._setupListeners(e),e}_setupListeners(e){let t=this.connection.peer,n=this.connection.connectionId,r=this.connection.type,i=this.connection.provider;Z.log(`Listening for ICE candidates.`),e.onicecandidate=e=>{!e.candidate||!e.candidate.candidate||(Z.log(`Received ICE candidates for ${t}:`,e.candidate),i.socket.send({type:Fp.Candidate,payload:{candidate:e.candidate,type:r,connectionId:n},dst:t}))},e.oniceconnectionstatechange=()=>{switch(e.iceConnectionState){case`failed`:Z.log(`iceConnectionState is failed, closing connections to `+t),this.connection.emitError(jp.NegotiationFailed,`Negotiation of connection to `+t+` failed.`),this.connection.close();break;case`closed`:Z.log(`iceConnectionState is closed, closing connections to `+t),this.connection.emitError(jp.ConnectionClosed,`Connection to `+t+` closed.`),this.connection.close();break;case`disconnected`:Z.log(`iceConnectionState changed to disconnected on the connection with `+t);break;case`completed`:e.onicecandidate=()=>{};break}this.connection.emit(`iceStateChanged`,e.iceConnectionState)},Z.log(`Listening for data channel`),e.ondatachannel=e=>{Z.log(`Received data channel`);let r=e.channel;i.getConnection(t,n)._initializeDataChannel(r)},Z.log(`Listening for remote stream`),e.ontrack=e=>{Z.log(`Received remote stream`);let r=e.streams[0],a=i.getConnection(t,n);if(a.type===kp.Media){let e=a;this._addStreamToMediaConnection(r,e)}}}cleanup(){Z.log(`Cleaning up PeerConnection to `+this.connection.peer);let e=this.connection.peerConnection;if(!e)return;this.connection.peerConnection=null,e.onicecandidate=e.oniceconnectionstatechange=e.ondatachannel=e.ontrack=()=>{};let t=e.signalingState!==`closed`,n=!1,r=this.connection.dataChannel;r&&(n=!!r.readyState&&r.readyState!==`closed`),(t||n)&&e.close()}async _makeOffer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createOffer(this.connection.options.constraints);Z.log(`Created offer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),Z.log(`Set localDescription:`,n,`for:${this.connection.peer}`);let r={sdp:n,type:this.connection.type,connectionId:this.connection.connectionId,metadata:this.connection.metadata};if(this.connection.type===kp.Data){let e=this.connection;r={...r,label:e.label,reliable:e.reliable,serialization:e.serialization}}t.socket.send({type:Fp.Offer,payload:r,dst:this.connection.peer})}catch(e){e!=`OperationError: Failed to set local offer sdp: Called in wrong state: kHaveRemoteOffer`&&(t.emitError(Ap.WebRTC,e),Z.log(`Failed to setLocalDescription, `,e))}}catch(e){t.emitError(Ap.WebRTC,e),Z.log(`Failed to createOffer, `,e)}}async _makeAnswer(){let e=this.connection.peerConnection,t=this.connection.provider;try{let n=await e.createAnswer();Z.log(`Created answer.`),this.connection.options.sdpTransform&&typeof this.connection.options.sdpTransform==`function`&&(n.sdp=this.connection.options.sdpTransform(n.sdp)||n.sdp);try{await e.setLocalDescription(n),Z.log(`Set localDescription:`,n,`for:${this.connection.peer}`),t.socket.send({type:Fp.Answer,payload:{sdp:n,type:this.connection.type,connectionId:this.connection.connectionId},dst:this.connection.peer})}catch(e){t.emitError(Ap.WebRTC,e),Z.log(`Failed to setLocalDescription, `,e)}}catch(e){t.emitError(Ap.WebRTC,e),Z.log(`Failed to create answer, `,e)}}async handleSDP(e,t){t=new RTCSessionDescription(t);let n=this.connection.peerConnection,r=this.connection.provider;Z.log(`Setting remote description`,t);let i=this;try{await n.setRemoteDescription(t),Z.log(`Set remoteDescription:${e} for:${this.connection.peer}`),e===`OFFER`&&await i._makeAnswer()}catch(e){r.emitError(Ap.WebRTC,e),Z.log(`Failed to setRemoteDescription, `,e)}}async handleCandidate(e){Z.log(`handleCandidate:`,e);try{await this.connection.peerConnection.addIceCandidate(e),Z.log(`Added ICE candidate for:${this.connection.peer}`)}catch(e){this.connection.provider.emitError(Ap.WebRTC,e),Z.log(`Failed to handleCandidate, `,e)}}_addTracksToConnection(e,t){if(Z.log(`add tracks from stream ${e.id} to peer connection`),!t.addTrack)return Z.error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);e.getTracks().forEach(n=>{t.addTrack(n,e)})}_addStreamToMediaConnection(e,t){Z.log(`add stream ${e.id} to media connection ${t.connectionId}`),t.addStream(e)}},zp=class extends bp.EventEmitter{emitError(e,t){Z.error(`Error:`,t),this.emit(`error`,new Bp(`${e}`,t))}},Bp=class extends Error{constructor(e,t){typeof t==`string`?super(t):(super(),Object.assign(this,t)),this.type=e}},Vp=class extends zp{get open(){return this._open}constructor(e,t,n){super(),this.peer=e,this.provider=t,this.options=n,this._open=!1,this.metadata=n.metadata}},Hp=class e extends Vp{static#e=this.ID_PREFIX=`mc_`;get type(){return kp.Media}get localStream(){return this._localStream}get remoteStream(){return this._remoteStream}constructor(t,n,r){super(t,n,r),this._localStream=this.options._stream,this.connectionId=this.options.connectionId||e.ID_PREFIX+vp.randomToken(),this._negotiator=new Rp(this),this._localStream&&this._negotiator.startConnection({_stream:this._localStream,originator:!0})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{Z.log(`DC#${this.connectionId} dc connection success`),this.emit(`willCloseOnRemote`)},this.dataChannel.onclose=()=>{Z.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}addStream(e){Z.log(`Receiving stream`,e),this._remoteStream=e,super.emit(`stream`,e)}handleMessage(e){let t=e.type,n=e.payload;switch(e.type){case Fp.Answer:this._negotiator.handleSDP(t,n.sdp),this._open=!0;break;case Fp.Candidate:this._negotiator.handleCandidate(n.candidate);break;default:Z.warn(`Unrecognized message type:${t} from peer:${this.peer}`);break}}answer(e,t={}){if(this._localStream){Z.warn(`Local stream already exists on this MediaConnection. Are you answering a call twice?`);return}this._localStream=e,t&&t.sdpTransform&&(this.options.sdpTransform=t.sdpTransform),this._negotiator.startConnection({...this.options._payload,_stream:e});let n=this.provider._getMessages(this.connectionId);for(let e of n)this.handleMessage(e);this._open=!0}close(){this._negotiator&&=(this._negotiator.cleanup(),null),this._localStream=null,this._remoteStream=null,this.provider&&=(this.provider._removeConnection(this),null),this.options&&this.options._stream&&(this.options._stream=null),this.open&&(this._open=!1,super.emit(`close`))}},Up=class{constructor(e){this._options=e}_buildRequest(e){let t=this._options.secure?`https`:`http`,{host:n,port:r,path:i,key:a}=this._options,o=new URL(`${t}://${n}:${r}${i}${a}/${e}`);return o.searchParams.set(`ts`,`${Date.now()}${Math.random()}`),o.searchParams.set(`version`,Ip),fetch(o.href,{referrerPolicy:this._options.referrerPolicy})}async retrieveId(){try{let e=await this._buildRequest(`id`);if(e.status!==200)throw Error(`Error. Status:${e.status}`);return e.text()}catch(e){Z.error(`Error retrieving ID`,e);let t=``;throw this._options.path===`/`&&this._options.host!==vp.CLOUD_HOST&&(t=" If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer."),Error(`Could not get an ID from the server.`+t)}}async listAllPeers(){try{let e=await this._buildRequest(`peers`);if(e.status!==200){if(e.status===401){let e=``;throw e=this._options.host===vp.CLOUD_HOST?`It looks like you're using the cloud server. You can email team@peerjs.com to enable peer listing for your API key.`:"You need to enable `allow_discovery` on your self-hosted PeerServer to use this feature.",Error(`It doesn't look like you have permission to list peers IDs. `+e)}throw Error(`Error. Status:${e.status}`)}return e.json()}catch(e){throw Z.error(`Error retrieving list peers`,e),Error(`Could not get list peers from the server.`+e)}}},Wp=class e extends Vp{static#e=this.ID_PREFIX=`dc_`;static#t=this.MAX_BUFFERED_AMOUNT=8388608;get type(){return kp.Data}constructor(t,n,r){super(t,n,r),this.connectionId=this.options.connectionId||e.ID_PREFIX+gp(),this.label=this.options.label||this.connectionId,this.reliable=!!this.options.reliable,this._negotiator=new Rp(this),this._negotiator.startConnection(this.options._payload||{originator:!0,reliable:this.reliable})}_initializeDataChannel(e){this.dataChannel=e,this.dataChannel.onopen=()=>{Z.log(`DC#${this.connectionId} dc connection success`),this._open=!0,this.emit(`open`)},this.dataChannel.onmessage=e=>{Z.log(`DC#${this.connectionId} dc onmessage:`,e.data)},this.dataChannel.onclose=()=>{Z.log(`DC#${this.connectionId} dc closed for:`,this.peer),this.close()}}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._negotiator&&=(this._negotiator.cleanup(),null),this.provider&&=(this.provider._removeConnection(this),null),this.dataChannel&&=(this.dataChannel.onopen=null,this.dataChannel.onmessage=null,this.dataChannel.onclose=null,null),this.open&&(this._open=!1,super.emit(`close`))}send(e,t=!1){if(!this.open){this.emitError(Mp.NotOpenYet,"Connection is not open. You should listen for the `open` event before sending messages.");return}return this._send(e,t)}async handleMessage(e){let t=e.payload;switch(e.type){case Fp.Answer:await this._negotiator.handleSDP(e.type,t.sdp);break;case Fp.Candidate:await this._negotiator.handleCandidate(t.candidate);break;default:Z.warn(`Unrecognized message type:`,e.type,`from peer:`,this.peer);break}}},Gp=class extends Wp{get bufferSize(){return this._bufferSize}_initializeDataChannel(e){super._initializeDataChannel(e),this.dataChannel.binaryType=`arraybuffer`,this.dataChannel.addEventListener(`message`,e=>this._handleDataMessage(e))}_bufferedSend(e){(this._buffering||!this._trySend(e))&&(this._buffer.push(e),this._bufferSize=this._buffer.length)}_trySend(e){if(!this.open)return!1;if(this.dataChannel.bufferedAmount>Wp.MAX_BUFFERED_AMOUNT)return this._buffering=!0,setTimeout(()=>{this._buffering=!1,this._tryBuffer()},50),!1;try{this.dataChannel.send(e)}catch(e){return Z.error(`DC#:${this.connectionId} Error when sending:`,e),this._buffering=!0,this.close(),!1}return!0}_tryBuffer(){if(!this.open||this._buffer.length===0)return;let e=this._buffer[0];this._trySend(e)&&(this._buffer.shift(),this._bufferSize=this._buffer.length,this._tryBuffer())}close(e){if(e?.flush){this.send({__peerData:{type:`close`}});return}this._buffer=[],this._bufferSize=0,super.close()}constructor(...e){super(...e),this._buffer=[],this._bufferSize=0,this._buffering=!1}},Kp=class extends Gp{close(e){super.close(e),this._chunkedData={}}constructor(e,t,n){super(e,t,n),this.chunker=new dp,this.serialization=Np.Binary,this._chunkedData={}}_handleDataMessage({data:e}){let t=Qd(e),n=t.__peerData;if(n){if(n.type===`close`){this.close();return}this._handleChunk(t);return}this.emit(`data`,t)}_handleChunk(e){let t=e.__peerData,n=this._chunkedData[t]||{data:[],count:0,total:e.total};if(n.data[e.n]=new Uint8Array(e.data),n.count++,this._chunkedData[t]=n,n.total===n.count){delete this._chunkedData[t];let e=fp(n.data);this._handleDataMessage({data:e})}}_send(e,t){let n=$d(e);if(n instanceof Promise)return this._send_blob(n);if(!t&&n.byteLength>this.chunker.chunkedMTU){this._sendChunks(n);return}this._bufferedSend(n)}async _send_blob(e){let t=await e;if(t.byteLength>this.chunker.chunkedMTU){this._sendChunks(t);return}this._bufferedSend(t)}_sendChunks(e){let t=this.chunker.chunk(e);Z.log(`DC#${this.connectionId} Try to send ${t.length} chunks...`);for(let e of t)this.send(e,!0)}},qp=class extends Gp{_handleDataMessage({data:e}){super.emit(`data`,e)}_send(e,t){this._bufferedSend(e)}constructor(...e){super(...e),this.serialization=Np.None}},Jp=class extends Gp{_handleDataMessage({data:e}){let t=this.parse(this.decoder.decode(e)),n=t.__peerData;if(n&&n.type===`close`){this.close();return}this.emit(`data`,t)}_send(e,t){let n=this.encoder.encode(this.stringify(e));if(n.byteLength>=vp.chunkedMTU){this.emitError(Mp.MessageToBig,`Message too big for JSON channel`);return}this._bufferedSend(n)}constructor(...e){super(...e),this.serialization=Np.JSON,this.encoder=new TextEncoder,this.decoder=new TextDecoder,this.stringify=JSON.stringify,this.parse=JSON.parse}},Yp=class e extends zp{static#e=this.DEFAULT_KEY=`peerjs`;get id(){return this._id}get options(){return this._options}get open(){return this._open}get socket(){return this._socket}get connections(){let e=Object.create(null);for(let[t,n]of this._connections)e[t]=n;return e}get destroyed(){return this._destroyed}get disconnected(){return this._disconnected}constructor(t,n){super(),this._serializers={raw:qp,json:Jp,binary:Kp,"binary-utf8":Kp,default:Kp},this._id=null,this._lastServerId=null,this._destroyed=!1,this._disconnected=!1,this._open=!1,this._connections=new Map,this._lostMessages=new Map;let r;if(t&&t.constructor==Object?n=t:t&&(r=t.toString()),n={debug:0,host:vp.CLOUD_HOST,port:vp.CLOUD_PORT,path:`/`,key:e.DEFAULT_KEY,token:vp.randomToken(),config:vp.defaultConfig,referrerPolicy:`strict-origin-when-cross-origin`,serializers:{},...n},this._options=n,this._serializers={...this._serializers,...this.options.serializers},this._options.host===`/`&&(this._options.host=window.location.hostname),this._options.path&&(this._options.path[0]!==`/`&&(this._options.path=`/`+this._options.path),this._options.path[this._options.path.length-1]!==`/`&&(this._options.path+=`/`)),this._options.secure===void 0&&this._options.host!==vp.CLOUD_HOST?this._options.secure=vp.isSecure():this._options.host==vp.CLOUD_HOST&&(this._options.secure=!0),this._options.logFunction&&Z.setLogFunction(this._options.logFunction),Z.logLevel=this._options.debug||0,this._api=new Up(n),this._socket=this._createServerConnection(),!vp.supports.audioVideo&&!vp.supports.data){this._delayedAbort(Ap.BrowserIncompatible,`The current browser does not support WebRTC`);return}if(r&&!vp.validateId(r)){this._delayedAbort(Ap.InvalidID,`ID "${r}" is invalid`);return}r?this._initialize(r):this._api.retrieveId().then(e=>this._initialize(e)).catch(e=>this._abort(Ap.ServerError,e))}_createServerConnection(){let e=new Lp(this._options.secure,this._options.host,this._options.port,this._options.path,this._options.key,this._options.pingInterval);return e.on(Pp.Message,e=>{this._handleMessage(e)}),e.on(Pp.Error,e=>{this._abort(Ap.SocketError,e)}),e.on(Pp.Disconnected,()=>{this.disconnected||(this.emitError(Ap.Network,`Lost connection to server.`),this.disconnect())}),e.on(Pp.Close,()=>{this.disconnected||this._abort(Ap.SocketClosed,`Underlying socket is already closed.`)}),e}_initialize(e){this._id=e,this.socket.start(e,this._options.token)}_handleMessage(e){let t=e.type,n=e.payload,r=e.src;switch(t){case Fp.Open:this._lastServerId=this.id,this._open=!0,this.emit(`open`,this.id);break;case Fp.Error:this._abort(Ap.ServerError,n.msg);break;case Fp.IdTaken:this._abort(Ap.UnavailableID,`ID "${this.id}" is taken`);break;case Fp.InvalidKey:this._abort(Ap.InvalidKey,`API KEY "${this._options.key}" is invalid`);break;case Fp.Leave:Z.log(`Received leave message from ${r}`),this._cleanupPeer(r),this._connections.delete(r);break;case Fp.Expire:this.emitError(Ap.PeerUnavailable,`Could not connect to peer ${r}`);break;case Fp.Offer:{let e=n.connectionId,t=this.getConnection(r,e);if(t&&(t.close(),Z.warn(`Offer received for existing Connection ID:${e}`)),n.type===kp.Media){let i=new Hp(r,this,{connectionId:e,_payload:n,metadata:n.metadata});t=i,this._addConnection(r,t),this.emit(`call`,i)}else if(n.type===kp.Data){let i=new this._serializers[n.serialization](r,this,{connectionId:e,_payload:n,metadata:n.metadata,label:n.label,serialization:n.serialization,reliable:n.reliable});t=i,this._addConnection(r,t),this.emit(`connection`,i)}else{Z.warn(`Received malformed connection type:${n.type}`);return}let i=this._getMessages(e);for(let e of i)t.handleMessage(e);break}default:{if(!n){Z.warn(`You received a malformed message from ${r} of type ${t}`);return}let i=n.connectionId,a=this.getConnection(r,i);a&&a.peerConnection?a.handleMessage(e):i?this._storeMessage(i,e):Z.warn(`You received an unrecognized message:`,e);break}}}_storeMessage(e,t){this._lostMessages.has(e)||this._lostMessages.set(e,[]),this._lostMessages.get(e).push(t)}_getMessages(e){let t=this._lostMessages.get(e);return t?(this._lostMessages.delete(e),t):[]}connect(e,t={}){if(t={serialization:`default`,...t},this.disconnected){Z.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.`),this.emitError(Ap.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}let n=new this._serializers[t.serialization](e,this,t);return this._addConnection(e,n),n}call(e,t,n={}){if(this.disconnected){Z.warn(`You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.`),this.emitError(Ap.Disconnected,`Cannot connect to new Peer after disconnecting from server.`);return}if(!t){Z.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");return}let r=new Hp(e,this,{...n,_stream:t});return this._addConnection(e,r),r}_addConnection(e,t){Z.log(`add connection ${t.type}:${t.connectionId} to peerId:${e}`),this._connections.has(e)||this._connections.set(e,[]),this._connections.get(e).push(t)}_removeConnection(e){let t=this._connections.get(e.peer);if(t){let n=t.indexOf(e);n!==-1&&t.splice(n,1)}this._lostMessages.delete(e.connectionId)}getConnection(e,t){let n=this._connections.get(e);if(!n)return null;for(let e of n)if(e.connectionId===t)return e;return null}_delayedAbort(e,t){setTimeout(()=>{this._abort(e,t)},0)}_abort(e,t){Z.error(`Aborting!`),this.emitError(e,t),this._lastServerId?this.disconnect():this.destroy()}destroy(){this.destroyed||(Z.log(`Destroy peer with ID:${this.id}`),this.disconnect(),this._cleanup(),this._destroyed=!0,this.emit(`close`))}_cleanup(){for(let e of this._connections.keys())this._cleanupPeer(e),this._connections.delete(e);this.socket.removeAllListeners()}_cleanupPeer(e){let t=this._connections.get(e);if(t)for(let e of t)e.close()}disconnect(){if(this.disconnected)return;let e=this.id;Z.log(`Disconnect peer with ID:${e}`),this._disconnected=!0,this._open=!1,this.socket.close(),this._lastServerId=e,this._id=null,this.emit(`disconnected`,e)}reconnect(){if(this.disconnected&&!this.destroyed)Z.log(`Attempting reconnection to server with ID ${this._lastServerId}`),this._disconnected=!1,this._initialize(this._lastServerId);else if(this.destroyed)throw Error(`This peer cannot reconnect to the server. It has already been destroyed.`);else if(!this.disconnected&&!this.open)Z.error(`In a hurry? We're still trying to make the initial connection!`);else throw Error(`Peer ${this.id} cannot reconnect because it is not disconnected from the server!`)}listAllPeers(e=e=>{}){this._api.listAllPeers().then(t=>e(t)).catch(e=>this._abort(Ap.ServerError,e))}},Xp=new Set([`carbine`,`smg`,`scattergun`]);function Zp(e){if(!e||typeof e!=`object`)return!1;let t=e;return typeof t.id==`string`&&t.id.length>0&&t.id.length<=80&&typeof t.name==`string`&&t.name.length>0&&t.name.length<=20&&(t.team===0||t.team===1)&&[`x`,`y`,`z`,`yaw`,`pitch`,`hp`,`kills`,`deaths`,`seq`].every(e=>Number.isFinite(t[e]))&&Xp.has(t.weapon)}function Qp(e){if(!e||typeof e!=`object`)return!1;let t=e;switch(t.type){case`join`:case`state`:return Zp(t.player);case`shot`:return typeof t.by==`string`&&Xp.has(t.weapon)&&Array.isArray(t.origin)&&t.origin.length===3&&t.origin.every(Number.isFinite)&&Array.isArray(t.direction)&&t.direction.length===3&&t.direction.every(Number.isFinite)&&Number.isFinite(t.nonce);case`hit`:return typeof t.by==`string`&&typeof t.target==`string`&&Number.isFinite(t.damage)&&Number(t.damage)>0&&Number(t.damage)<=100&&Number.isFinite(t.nonce);case`death`:return typeof t.killer==`string`&&typeof t.victim==`string`&&Number.isFinite(t.nonce);case`leave`:return typeof t.playerId==`string`;case`chat`:return typeof t.by==`string`&&typeof t.text==`string`&&t.text.length<=160;default:return!1}}function $p(e){return e.replace(/[^a-zA-Z0-9 _-]/g,``).trim().slice(0,16)||`Player${Math.floor(Math.random()*900+100)}`}var em=class{role=`offline`;roomCode=``;peer=null;hostConnection=null;guests=new Set;onMessage;onStatus;onReady=null;constructor(e,t){this.onMessage=e,this.onStatus=t}host(e){this.close(),this.role=`host`,this.onReady=e,this.onStatus(`Opening a secure peer lobby…`);let t=new Yp;this.peer=t,t.on(`open`,t=>{this.roomCode=t,this.onStatus(`Lobby ready — share the room code`,`ok`),e()}),t.on(`connection`,e=>this.wireGuest(e)),t.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),t.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; existing peers may continue`,`warn`))}join(e,t){if(this.close(),this.role=`client`,this.roomCode=e.trim(),this.onReady=t,!this.roomCode){this.onStatus(`Enter a room code first`,`error`);return}this.onStatus(`Connecting to peer lobby…`);let n=new Yp;this.peer=n,n.on(`open`,()=>{let e=n.connect(this.roomCode,{reliable:!0,serialization:`json`});this.hostConnection=e,this.wireHost(e)}),n.on(`error`,e=>this.onStatus(this.describeError(e),`error`)),n.on(`disconnected`,()=>this.onStatus(`Signalling disconnected; attempting to preserve session`,`warn`))}send(e){Qp(e)&&(this.role===`host`?this.broadcast(e):this.role===`client`&&this.hostConnection?.open&&this.hostConnection.send(e))}close(){if(this.hostConnection)try{this.hostConnection.close()}catch{}for(let e of this.guests)try{e.close()}catch{}if(this.guests.clear(),this.hostConnection=null,this.peer)try{this.peer.destroy()}catch{}this.peer=null,this.roomCode=``,this.role=`offline`,this.onReady=null}wireGuest(e){this.guests.add(e);let t=``;e.on(`open`,()=>this.onStatus(`${this.guests.size} guest connection${this.guests.size===1?``:`s`}`,`ok`)),e.on(`data`,n=>{Qp(n)&&(n.type===`join`&&(t=n.player.id),this.onMessage(n),this.broadcast(n,e))}),e.on(`close`,()=>{if(this.guests.delete(e),t){let e={type:`leave`,playerId:t};this.onMessage(e),this.broadcast(e)}this.onStatus(`A guest left the lobby`,`warn`)}),e.on(`error`,()=>this.onStatus(`Guest data channel failed`,`error`))}wireHost(e){e.on(`open`,()=>{this.onStatus(`Connected to host`,`ok`),this.onReady?.()}),e.on(`data`,e=>{Qp(e)&&this.onMessage(e)}),e.on(`close`,()=>this.onStatus(`Host connection closed`,`error`)),e.on(`error`,()=>this.onStatus(`Could not establish peer data channel`,`error`))}broadcast(e,t){for(let n of this.guests)n!==t&&n.open&&n.send(e)}describeError(e){let t=e instanceof Error?e.message:String(e);return/peer-unavailable/i.test(t)?`Room not found. Check the code and try again.`:/network|server/i.test(t)?`Peer signalling is unavailable. Check the connection and retry.`:`Network error: ${t.slice(0,120)}`}},tm=`modulepreload`,nm=function(e,t){return new URL(e,t).href},rm={},im=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,new URL(`../../../src/node/plugins/importAnalysisBuild.ts`,import.meta.url)).href}r=o(t.map(t=>{if(t=nm(t,n),t=s(t),t in rm)return;rm[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:tm,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},am=.38,om=.53,sm=.72,cm=class e{world;body;collider;controller;constructor(e,t,n){this.world=e,this.body=t,this.collider=n,this.controller=e.createCharacterController(.025),this.controller.setSlideEnabled(!0),this.controller.enableAutostep(.42,.22,!1),this.controller.enableSnapToGround(.24),this.controller.setMaxSlopeClimbAngle(50*Math.PI/180),this.controller.setMinSlopeSlideAngle(55*Math.PI/180)}static async create(t,n){let{default:r}=await im(async()=>{let{default:e}=await import(`./rapier-B45baom8.js`);return{default:e}},[],import.meta.url);await r.init();let i=new r.World({x:0,y:-22,z:0});i.timestep=1/120,i.createCollider(r.ColliderDesc.cuboid((n.maxX-n.minX)/2,.1,(n.maxZ-n.minZ)/2).setTranslation((n.minX+n.maxX)/2,-.1,(n.minZ+n.maxZ)/2));for(let e of t){let t=e.minY??0,n=e.maxY??8,a=Math.max(.01,(e.maxX-e.minX)/2),o=Math.max(.01,(n-t)/2),s=Math.max(.01,(e.maxZ-e.minZ)/2);i.createCollider(r.ColliderDesc.cuboid(a,o,s).setTranslation((e.minX+e.maxX)/2,(t+n)/2,(e.minZ+e.maxZ)/2))}let a=i.createRigidBody(r.RigidBodyDesc.kinematicPositionBased()),o=i.createCollider(r.ColliderDesc.capsule(om,am).setFriction(0).setActiveCollisionTypes(r.ActiveCollisionTypes.ALL),a),s=new e(i,a,o);return s.teleportEye({x:0,y:1.7,z:0}),s}teleportEye(e){this.body.setTranslation({x:e.x,y:e.y-sm,z:e.z},!0),this.world.propagateModifiedBodyPositionsToColliders()}eyePosition(){let e=this.body.translation();return{x:e.x,y:e.y+sm,z:e.z}}move(e,t){this.world.timestep=t,this.controller.computeColliderMovement(this.collider,e);let n=this.controller.computedMovement(),r=this.body.translation();this.body.setNextKinematicTranslation({x:r.x+n.x,y:r.y+n.y,z:r.z+n.z}),this.world.step();let i=this.eyePosition(),a=5e-4;return{position:i,grounded:this.controller.computedGrounded(),blockedX:Math.abs(n.x-e.x)>a,blockedY:Math.abs(n.y-e.y)>a,blockedZ:Math.abs(n.z-e.z)>a}}dispose(){this.world.free()}},lm={carbine:`./assets/kenney/blaster/blaster-p.glb`,smg:`./assets/kenney/blaster/blaster-g.glb`,scattergun:`./assets/kenney/blaster/blaster-a.glb`},um=class{root=new In;models=new Map;active=`carbine`;recoil=0;reloadStart=0;reloadDuration=0;switchBlend=1;swayX=0;swayY=0;constructor(e){this.root.name=`authored-weapon-view`,this.root.position.set(.34,-.28,-.62),e.add(this.root)}async load(e){let t=new qu,n=0,r=Object.entries(lm),i=await Promise.all(r.map(async([i,a])=>{let o=await t.loadAsync(a);return n+=1,e?.(n,r.length),[i,this.prepareModel(o.scene,i)]}));for(let[e,t]of i)this.models.set(e,t),this.root.add(t);this.setWeapon(this.active,!0)}isReady(){return this.models.size===Object.keys(lm).length}setWeapon(e,t=!1){this.active=e,this.switchBlend=+!!t;for(let[t,n]of this.models)n.visible=t===e}fire(e){this.recoil=Math.min(1,this.recoil+.28+e*5)}reload(e){this.reloadStart=performance.now(),this.reloadDuration=e*1e3}addMouseDelta(e,t){this.swayX=zt.clamp(this.swayX+e*8e-5,-.025,.025),this.swayY=zt.clamp(this.swayY+t*6e-5,-.02,.02)}update(e){let t=t=>1-Math.exp(-t*e.dt);this.recoil=zt.lerp(this.recoil,0,t(16)),this.switchBlend=zt.lerp(this.switchBlend,1,t(10)),this.swayX=zt.lerp(this.swayX,0,t(7)),this.swayY=zt.lerp(this.swayY,0,t(7));let n=e.moving?e.sprinting?1.35:e.ads?.22:.62:.08,r=Math.cos(e.phase*.5)*.018*n,i=Math.sin(e.phase)*.022*n,a=e.ads?-.335:0,o=e.ads?.225:0,s=e.ads?.18:0,c=e.sprinting?-.16:0,l=(1-this.switchBlend)*-.34,u=0,d=0;if(this.reloadDuration>0){let e=(performance.now()-this.reloadStart)/this.reloadDuration;if(e>=1)this.reloadDuration=0;else{let t=Math.sin(Math.PI*zt.clamp(e,0,1));u=t*.7,d=t*-.16}}let f=new H(.34+a+r+this.swayX,-.28+o+i+c+l+d-this.recoil*.08,-.62+s+this.recoil*.13);this.root.position.lerp(f,t(18)),this.root.rotation.x=zt.lerp(this.root.rotation.x,this.recoil*.18-this.swayY,t(22)),this.root.rotation.y=zt.lerp(this.root.rotation.y,-this.swayX*2+(e.sprinting?-.38:0),t(13)),this.root.rotation.z=zt.lerp(this.root.rotation.z,u+(e.sprinting?-.22:0),t(13))}prepareModel(e,t){let n=e.clone(!0);n.name=`${t}-authored-model`,n.traverse(e=>{if(!(e instanceof q))return;e.castShadow=!0,e.receiveShadow=!1;let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)e instanceof Xa&&(e.roughness=Math.min(e.roughness,.72),e.metalness=Math.max(e.metalness,.12))});let r=new or().setFromObject(n),i=r.getCenter(new H),a=r.getSize(new H),o=(t===`scattergun`?.92:t===`smg`?.72:.86)/Math.max(a.x,a.y,a.z,.001);return n.scale.setScalar(o),n.position.copy(i.multiplyScalar(-o)),n.rotation.y=Math.PI,n.rotation.x=-.06,n.visible=!1,n}};window.addEventListener(`error`,e=>{console.error(`[Atomic Acres runtime error]`,e.message||`unknown error`,e.error?.stack||``)}),window.addEventListener(`unhandledrejection`,e=>{let t=e.reason instanceof Error?`${e.reason.message}\n${e.reason.stack??``}`:String(e.reason);console.error(`[Atomic Acres unhandled rejection]`,t)});var dm={carbine:{id:`carbine`,name:`M86 Carbine`,damage:31,rpm:540,mag:24,reserve:96,reload:1.75,spread:.008,pellets:1,recoil:.018,automatic:!1,color:16765286},smg:{id:`smg`,name:`Vectorline SMG`,damage:18,rpm:820,mag:32,reserve:128,reload:1.45,spread:.019,pellets:1,recoil:.011,automatic:!0,color:6678527},scattergun:{id:`scattergun`,name:`Model 12 Scattergun`,damage:13,rpm:90,mag:8,reserve:40,reload:2.3,spread:.072,pellets:9,recoil:.05,automatic:!1,color:16747099}},fm=[`carbine`,`smg`,`scattergun`];function pm(){return typeof globalThis.crypto?.randomUUID==`function`?globalThis.crypto.randomUUID():`player-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,10)}`}var mm=document.querySelector(`#app`);if(!mm)throw Error(`Missing #app root`);mm.innerHTML=`
...
`;function Q(e){let t=document.querySelector(e);if(!t)throw Error(`Missing element ${e}`);return t}var hm=Q(`#game`),gm=Q(`#menu`),_m=Q(`#hud`),vm=Q(`#room-card`),ym=Q(`#room-code`),bm=Q(`#network-status`),xm=new zu,Sm=new Ru({canvas:hm,antialias:!0,powerPreference:`high-performance`});Sm.outputColorSpace=Ze,Sm.shadowMap.enabled=!0,Sm.shadowMap.type=1,Sm.toneMapping=4,Sm.toneMappingExposure=1.15,Sm.setPixelRatio(Math.min(window.devicePixelRatio,1.75));var Cm=new Gn;Cm.fog=new Wn(15251329,55,118);var wm=new Wo(76,1,.08,180);wm.rotation.order=`YXZ`,Cm.add(wm);function Tm(){let e=new za(150,32,18),t=new Ja({side:1,depthWrite:!1,uniforms:{top:{value:new K(4030384)},horizon:{value:new K(16106111)},bottom:{value:new K(15655097)}},vertexShader:`varying vec3 worldPos; void main(){ worldPos=(modelMatrix*vec4(position,1.0)).xyz; gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0); }`,fragmentShader:`varying vec3 worldPos; uniform vec3 top; uniform vec3 horizon; uniform vec3 bottom; void main(){ float h=normalize(worldPos).y; vec3 c=h>0.0?mix(horizon,top,smoothstep(0.0,.75,h)):mix(horizon,bottom,smoothstep(0.0,-.35,h)); gl_FragColor=vec4(c,1.0); }`});Cm.add(new q(e,t)),Cm.add(new Mo(14282751,4413491,1.45));let n=new Zo(16768946,2.3);n.position.set(-38,74,22),n.castShadow=!0,n.shadow.mapSize.set(2048,2048),n.shadow.camera.left=-60,n.shadow.camera.right=60,n.shadow.camera.top=65,n.shadow.camera.bottom=-65,n.shadow.camera.near=10,n.shadow.camera.far=150,n.shadow.bias=-4e-4,Cm.add(n)}Tm();var Em=Uu(Cm),$={id:pm(),name:`Player`,team:0,position:new H,velocity:new H,yaw:0,pitch:0,hp:100,kills:0,deaths:0,weapon:`carbine`,ammo:{carbine:24,smg:32,scattergun:8},reserve:{carbine:96,smg:128,scattergun:40},reloadingUntil:0,lastShotAt:0,alive:!0,invulnerableUntil:0,seq:0},Dm=new Set,Om=new Map,km=new Set,Am=!1,jm=!1,Mm=0,Nm=0,Pm=0,Fm=0,Im=0,Lm=performance.now(),Rm=!1,zm=!1,Bm=!1,Vm=null;function Hm(e,t=`ok`){bm.textContent=e,bm.dataset.kind=t}function Um(e){let t=e instanceof Error?e.message:String(e);jm=!1,Hm(`Game paused: ${t}`,`error`),gm.classList.remove(`hidden`);let n=Q(`#banner`);n.innerHTML=`<strong>SYSTEM PAUSED</strong><span>Reload the page to re-enter the test block.</span>`,n.hidden=!1,console.error(`[Atomic Acres fatal]`,e)}var Wm=typeof window.RTCPeerConnection==`function`;Wm?typeof hm.requestPointerLock!=`function`&&Hm(`Pointer lock is unavailable; keyboard movement works but mouse aim may not.`,`warn`):(Q(`#host`).disabled=!0,Q(`#join`).disabled=!0,Hm(`This browser lacks WebRTC; solo training is still available.`,`warn`)),hm.addEventListener(`webglcontextlost`,e=>{e.preventDefault(),Um(Error(`Graphics context was lost`))}),hm.addEventListener(`webglcontextrestored`,()=>window.location.reload());var Gm=new em(Xm,Hm),Km=new um(wm),qm=new Jo(14216447,.9,5);qm.position.set(0,.4,.2),wm.add(qm);function Jm(e){let t=new In;t.name=`remote-player`,t.userData.playerId=e.id;let n=new Xa({color:e.team===0?5428690:16741983,roughness:.62}),r=new Xa({color:2107953,roughness:.8}),i=new q(new Pa(.4,1.05,5,10),n);i.position.y=.96,i.castShadow=!0;let a=new q(new za(.25,12,10),r);a.position.y=1.85,a.castShadow=!0;let o=new q(new Na(.12,.12,.7),r);o.position.set(.28,1.25,-.35),t.add(i,a,o),t.traverse(t=>{t.userData.playerId=e.id});let s=document.createElement(`canvas`);s.width=256,s.height=64;let c=s.getContext(`2d`);c.fillStyle=`rgba(10,18,22,.72)`,c.fillRect(0,0,256,64),c.fillStyle=`#f7ecd4`,c.font=`700 30px Arial`,c.textAlign=`center`,c.textBaseline=`middle`,c.fillText(e.name,128,32);let l=new ka(s);l.colorSpace=Ze;let u=new ai(new Gr({map:l,transparent:!0,depthTest:!1}));return u.position.y=2.5,u.scale.set(2.4,.6,1),t.add(u),t.position.set(e.x,e.y-1.7,e.z),Cm.add(t),{root:t,snapshot:e,target:new H(e.x,e.y-1.7,e.z),targetYaw:e.yaw,lastSeen:performance.now()}}function Ym(){return{id:$.id,name:$.name,team:$.team,x:$.position.x,y:$.position.y,z:$.position.z,yaw:$.yaw,pitch:$.pitch,hp:$.hp,kills:$.kills,deaths:$.deaths,weapon:$.weapon,seq:++$.seq}}function Xm(e){if(e.type===`join`||e.type===`state`){let t=e.player;if(t.id===$.id)return;let n=Om.get(t.id);n||(n=Jm(t),Om.set(t.id,n),gh(`${t.name} entered the test block`,t.team===0?`aqua`:`coral`),e.type===`join`&&Gm.send({type:`state`,player:Ym()})),t.seq>=n.snapshot.seq&&(n.snapshot=t,n.target.set(t.x,t.y-1.7,t.z),n.targetYaw=t.yaw,n.lastSeen=performance.now(),n.root.visible=t.hp>0);return}if(e.type===`shot`){e.by!==$.id&&Qm(e);return}if(e.type===`hit`&&e.target===$.id&&!km.has(e.nonce)){km.add(e.nonce),$m(e.damage,e.by),Zm();return}if(e.type===`death`&&!km.has(e.nonce)){km.add(e.nonce),eh(e),Zm();return}e.type===`leave`&&th(e.playerId,`left the block`)}function Zm(){km.size>512&&km.clear()}function Qm(e){mh(new H(...e.origin),new H(...e.direction).normalize(),50,dm[e.weapon].color),xm.shot(e.weapon,!0)}function $m(e,t){let n=performance.now();if(!(!$.alive||n<$.invulnerableUntil)&&($.hp=Math.max(0,$.hp-Math.min(100,Math.max(1,e))),Q(`#damage-flash`).classList.remove(`pulse`),requestAnimationFrame(()=>Q(`#damage-flash`).classList.add(`pulse`)),$.hp<=0)){$.alive=!1,$.deaths+=1;let e={type:`death`,killer:t,victim:$.id,nonce:oh()};Gm.send(e),eh(e),Q(`#respawn`).hidden=!1,document.exitPointerLock(),setTimeout(ih,1900)}}function eh(e){let t=e.killer===$.id?$.name:Om.get(e.killer)?.snapshot.name??`Unknown`,n=e.victim===$.id?$.name:Om.get(e.victim)?.snapshot.name??`Unknown`;e.killer===$.id&&e.victim!==$.id&&($.kills+=1),gh(`${t} eliminated ${n}`,e.killer===$.id?`gold`:void 0);let r=Om.get(e.victim);r&&(r.root.visible=!1),bh()}function th(e,t){let n=Om.get(e);n&&(Cm.remove(n.root),Om.delete(e),gh(`${n.snapshot.name} ${t}`))}function nh(){let e=Em.spawns[$.team],t=[...Om.values()].map(e=>e.target),n=e.map(e=>({point:e,distance:t.length?Math.min(...t.map(t=>t.distanceToSquared(e))):1/0}));return n.sort((e,t)=>t.distance-e.distance),n[0].point.clone()}function rh(){try{let e=hm.requestPointerLock();e instanceof Promise&&e.catch(()=>void 0)}catch{}}function ih(){$.position.copy(nh()),Vm?.teleportEye($.position),$.velocity.set(0,0,0),$.hp=100,$.alive=!0,$.invulnerableUntil=performance.now()+1350,$.yaw=$.team===0?Math.PI:0,$.pitch=0,Q(`#respawn`).hidden=!0,Am&&rh(),Gm.send({type:`state`,player:Ym()})}function ah(e){$.name=$p(Q(`#player-name`).value),$.team=+(Number(Q(`#team`).value)===1),Am=!0,Rm=!1,Mm=performance.now(),gm.classList.add(`hidden`),_m.hidden=!1,Q(`#connection-pill`).textContent=e===`solo`?`SOLO DRILL`:e===`host`?`HOST`:`PEER`,Q(`#room-hud`).textContent=Gm.roomCode?`ROOM ${Gm.roomCode.slice(0,8).toUpperCase()}`:``,ih(),xm.unlock(),gh(`Welcome to Atomic Acres`,`gold`),e!==`solo`&&Gm.send({type:`join`,player:Ym()})}function oh(){return Math.floor(performance.now()*1e3+Math.random()*1e6)}function sh(e){let t=fm[e];!t||t===$.weapon||($.weapon=t,$.reloadingUntil=0,Km.setWeapon(t))}function ch(){if(!$.alive)return;let e=dm[$.weapon],t=$.ammo[$.weapon];$.reloadingUntil||t>=e.mag||$.reserve[$.weapon]<=0||($.reloadingUntil=performance.now()+e.reload*1e3,xm.reload(),Km.reload(e.reload),gh(`Reloading ${e.name}`))}function lh(e){if(!$.reloadingUntil||e<$.reloadingUntil)return;let t=dm[$.weapon].mag-$.ammo[$.weapon],n=Math.min(t,$.reserve[$.weapon]);$.ammo[$.weapon]+=n,$.reserve[$.weapon]-=n,$.reloadingUntil=0}function uh(e){if(!$.alive||!Am||document.pointerLockElement!==hm||Rm)return;let t=dm[$.weapon];if(!jm&&t.automatic||$.reloadingUntil||e-$.lastShotAt<6e4/t.rpm)return;if($.ammo[$.weapon]<=0){xm.empty(),ch(),$.lastShotAt=e;return}$.lastShotAt=e,--$.ammo[$.weapon],Fm=Math.min(.22,Fm+t.recoil*3.8),$.pitch=Math.max(-1.42,$.pitch-t.recoil),Km.fire(t.recoil),xm.shot($.weapon);let n=wm.getWorldPosition(new H),r=wm.getWorldDirection(new H),i=new Map;for(let e=0;e<t.pellets;e+=1){let e=r.clone();e.x+=(Math.random()-.5)*t.spread,e.y+=(Math.random()-.5)*t.spread,e.z+=(Math.random()-.5)*t.spread,e.normalize();let a=dh(n,e);mh(n,e,a.distance,t.color),a.playerId&&i.set(a.playerId,(i.get(a.playerId)??0)+t.damage),a.targetId&&fh(a.targetId)}for(let[e,t]of i){let n=oh();Gm.send({type:`hit`,by:$.id,target:e,damage:Math.min(100,t),nonce:n}),hh(),xm.hit()}let a={type:`shot`,by:$.id,weapon:$.weapon,origin:n.toArray(),direction:r.toArray(),nonce:oh()};Gm.send(a),$.ammo[$.weapon]===0&&setTimeout(ch,120)}function dh(e,t){let n=new vs(e,t,.1,110),r=[...Om.values()].filter(e=>e.root.visible).map(e=>e.root),i=Em.targets.filter(e=>e.active).map(e=>e.root),a=n.intersectObjects([...Em.raycastMeshes,...r,...i],!0)[0];if(!a)return{distance:90};let o=a.object;for(;o&&o.parent&&o.parent!==Cm&&!(o.userData.playerId||o.userData.targetId);)o=o.userData.targetRoot?o.userData.targetRoot:o.parent;let s=a.object.userData.playerId,c=a.object.userData.targetRoot?.userData.targetId??o?.userData.targetId;return{distance:Math.min(a.distance,110),playerId:s,targetId:c}}function fh(e){let t=Em.targets.find(t=>t.id===e);!t||!t.active||(t.active=!1,t.root.visible=!1,t.respawnAt=performance.now()+3200,Nm+=1,hh(),xm.hit(),gh(`+1 test mannequin`,`gold`))}function ph(e){for(let t of Em.targets)!t.active&&e>=t.respawnAt&&(t.active=!0,t.root.visible=!0)}function mh(e,t,n,r){let i=new zr().setFromPoints([e.clone(),e.clone().addScaledVector(t,n)]),a=new ha(i,new sa({color:r,transparent:!0,opacity:.72}));Cm.add(a),setTimeout(()=>{Cm.remove(a),i.dispose(),a.material.dispose()},55)}function hh(){let e=Q(`#hitmarker`);e.classList.remove(`show`),requestAnimationFrame(()=>e.classList.add(`show`))}function gh(e,t){let n=Q(`#killfeed`),r=document.createElement(`div`);for(r.textContent=e,t&&r.classList.add(t),n.prepend(r);n.children.length>6;)n.lastElementChild?.remove();setTimeout(()=>r.classList.add(`fade`),4200),setTimeout(()=>r.remove(),5e3)}function _h(e){if(!Am||!$.alive||Rm||!Vm)return;let t=new H(-Math.sin($.yaw),0,-Math.cos($.yaw)),n=new H(Math.cos($.yaw),0,-Math.sin($.yaw)),r=new H;Dm.has(`KeyW`)&&r.add(t),Dm.has(`KeyS`)&&r.sub(t),Dm.has(`KeyD`)&&r.add(n),Dm.has(`KeyA`)&&r.sub(n),r.lengthSq()>0&&r.normalize();let i=Dm.has(`ShiftLeft`)&&r.lengthSq()>0&&!zm,a=i?43:34,o=i?10.6:zm?4.2:7.2;$.velocity.x+=r.x*a*e,$.velocity.z+=r.z*a*e;let s=Math.exp(-8.5*e);$.velocity.x*=s,$.velocity.z*=s;let c=Math.hypot($.velocity.x,$.velocity.z);c>o&&($.velocity.x*=o/c,$.velocity.z*=o/c),$.velocity.y-=22*e,Bm&&($.velocity.y=Math.max(0,$.velocity.y),Dm.has(`Space`)&&!zm&&($.velocity.y=7.1,Bm=!1));let l=Vm.move({x:$.velocity.x*e,y:$.velocity.y*e,z:$.velocity.z*e},e);$.position.set(l.position.x,l.position.y,l.position.z),Bm=l.grounded,l.blockedX&&($.velocity.x=0),l.blockedY&&$.velocity.y<0&&($.velocity.y=0),l.blockedZ&&($.velocity.z=0);let u=r.lengthSq()>0&&Bm;Im+=e*(i?15:10)*(u?1:.25),Fm=Vu(Fm,0,15,e),Km.update({dt:e,moving:u,sprinting:i,ads:zm,phase:Im}),wm.fov=Vu(wm.fov,zm?62:i?81:76,9,e),wm.updateProjectionMatrix(),wm.position.copy($.position),wm.rotation.y=$.yaw,wm.rotation.x=$.pitch}function vh(e,t){for(let[n,r]of Om){if(t-r.lastSeen>12e3){th(n,`timed out`);continue}let i=1-Math.exp(-13*e);r.root.position.lerp(r.target,i),r.root.rotation.y+=Bu(r.root.rotation.y,r.targetYaw)*i}}function yh(){let e=$.team===0?$.kills:0,t=$.team===1?$.kills:0;for(let n of Om.values())n.snapshot.team===0?e+=n.snapshot.kills:t+=n.snapshot.kills;return[e,t]}function bh(){let[e,t]=yh();if(Rm||e<25&&t<25)return;Rm=!0;let n=($.team===0?e:t)>=25,r=Q(`#banner`);r.innerHTML=`<strong>${n?`VICTORY`:`DEFEAT`}</strong><span>${e} — ${t}</span>`,r.hidden=!1,document.exitPointerLock()}function xh(e){let t=dm[$.weapon],[n,r]=yh();Q(`#health`).textContent=String(Math.ceil($.hp)),Q(`#health-fill`).style.width=`${$.hp}%`,Q(`#weapon-name`).textContent=t.name.toUpperCase(),Q(`#ammo`).textContent=String($.ammo[$.weapon]),Q(`#reserve`).textContent=String($.reserve[$.weapon]),Q(`#aqua-score`).textContent=String(n),Q(`#coral-score`).textContent=String(r);let i=Math.max(0,300-Math.floor((e-Mm)/1e3));if(Q(`#timer`).textContent=`${String(Math.floor(i/60)).padStart(2,`0`)}:${String(i%60).padStart(2,`0`)}`,Q(`#reload-state`).textContent=$.reloadingUntil?`RELOADING ${Math.max(0,($.reloadingUntil-e)/1e3).toFixed(1)}s`:Gm.role===`offline`?`${Nm} TARGETS HIT`:`${$.kills} K / ${$.deaths} D`,Q(`#health-block`).classList.toggle(`critical`,$.hp<=30),i===0&&!Rm){Rm=!0;let e=($.team===0?n:r)>=($.team===0?r:n),t=Q(`#banner`);t.innerHTML=`<strong>${e?`TIME — VICTORY`:`TIME — DEFEAT`}</strong><span>${n} — ${r}</span>`,t.hidden=!1,document.exitPointerLock()}Sh()}function Sh(){let e=[Ym(),...[...Om.values()].map(e=>e.snapshot)].sort((e,t)=>t.kills-e.kills||e.deaths-t.deaths);Q(`#roster-list`).innerHTML=e.map(e=>`<div><span class="${e.team===0?`aqua`:`coral`}">${Ch(e.name)}</span><b>${e.kills}</b><i>${e.deaths}</i><em>${e.hp>0?e.hp+` HP`:`DOWN`}</em></div>`).join(``)}function Ch(e){return e.replace(/[&<>'"]/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,"'":`&#39;`,'"':`&quot;`})[e])}function wh(){let e=window.innerWidth,t=window.innerHeight;Sm.setSize(e,t,!1),wm.aspect=e/Math.max(1,t),wm.updateProjectionMatrix()}window.addEventListener(`resize`,wh),wh();var Th=new URLSearchParams(window.location.search),Eh=Th.get(`room`)?.trim()??``;Eh&&(Q(`#room-input`).value=Eh);var Dh=Th.get(`name`);Dh&&(Q(`#player-name`).value=$p(Dh)),Th.get(`team`)===`1`&&(Q(`#team`).value=`1`),window.addEventListener(`keydown`,e=>{Dm.add(e.code),e.code===`Digit1`&&sh(0),e.code===`Digit2`&&sh(1),e.code===`Digit3`&&sh(2),e.code===`KeyR`&&ch(),e.code===`Tab`&&(e.preventDefault(),Q(`#roster`).hidden=!1)}),window.addEventListener(`keyup`,e=>{Dm.delete(e.code),e.code===`Tab`&&(Q(`#roster`).hidden=!0)}),window.addEventListener(`blur`,()=>{Dm.clear(),jm=!1,zm=!1}),window.addEventListener(`mousemove`,e=>{document.pointerLockElement!==hm||!$.alive||($.yaw-=e.movementX*.00215,$.pitch=Math.max(-1.42,Math.min(1.42,$.pitch-e.movementY*.0019)),Km.addMouseDelta(e.movementX,e.movementY))}),hm.addEventListener(`contextmenu`,e=>e.preventDefault()),hm.addEventListener(`mousedown`,e=>{if(document.pointerLockElement!==hm){rh();return}if(e.button===2){zm=!0;return}e.button===0&&(jm=!0,uh(performance.now()))}),window.addEventListener(`mouseup`,e=>{e.button===0&&(jm=!1),e.button===2&&(zm=!1)}),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement===hm?(Q(`#resume`).hidden=!0,gm.classList.add(`hidden`)):(jm=!1,zm=!1,Am&&$.alive&&(Q(`#resume`).hidden=Rm,gm.classList.remove(`hidden`)))});function Oh(){$.kills=0,$.deaths=0,$.hp=100,Nm=0;for(let e of Om.keys())th(e,`cleared`);Q(`#banner`).hidden=!0,$.ammo={carbine:24,smg:32,scattergun:8},$.reserve={carbine:96,smg:128,scattergun:40}}Q(`#resume`).addEventListener(`click`,()=>{Am&&$.alive&&!Rm&&rh()}),Q(`#solo`).addEventListener(`click`,()=>{Gm.close(),Oh(),ah(`solo`)}),Q(`#host`).addEventListener(`click`,()=>{Oh(),Gm.host(()=>{vm.hidden=!1,ym.textContent=Gm.roomCode,ah(`host`)})}),Q(`#join`).addEventListener(`click`,()=>{Oh();let e=Q(`#room-input`).value.trim();Gm.join(e,()=>ah(`client`))}),Q(`#copy-room`).addEventListener(`click`,async()=>{let e=`${window.location.origin}${window.location.pathname}?room=${encodeURIComponent(Gm.roomCode)}`;try{await navigator.clipboard.writeText(e),Hm(`Invite link copied`,`ok`)}catch{Q(`#room-input`).value=Gm.roomCode,Hm(`Clipboard blocked — code placed in join field`,`warn`)}}),Eh&&Th.get(`autojoin`)===`1`&&window.setTimeout(()=>Q(`#join`).click(),100),setInterval(()=>{Am&&Gm.role!==`offline`&&$.alive&&Gm.send({type:`state`,player:Ym()})},60),window.addEventListener(`beforeunload`,()=>{Gm.role!==`offline`&&Gm.send({type:`leave`,playerId:$.id}),Gm.close()});function kh(e){try{let t=Math.min(.05,Math.max(0,(e-Lm)/1e3));Lm=e,Pm+=t;let n=1/120,r=0;for(;Pm>=n&&r<6;)_h(n),Pm-=n,r+=1;jm&&dm[$.weapon].automatic&&uh(e),lh(e),ph(e),vh(t,e),xh(e),Sm.render(Cm,wm),requestAnimationFrame(kh)}catch(e){Um(e)}}async function Ah(){let e=Q(`#solo`),t=Q(`#host`),n=Q(`#join`);e.disabled=!0,t.disabled=!0,n.disabled=!0,Hm(`Loading authored arena art, weapons and advanced collision…`);let r=cm.create(Em.colliders,Em.bounds),i=Km.load((e,t)=>{Hm(`Loading authored weapons ${e}/${t}…`)}),a=Jd(Cm,(e,t)=>{Hm(`Loading authored arena models ${e}/${t}…`)}),[o]=await Promise.all([r,i,a]);Vm=o,Km.setWeapon($.weapon,!0),ih(),e.disabled=!1,t.disabled=!Wm,n.disabled=!Wm,Hm(`V2 foundation ready — authored arena art and weapons, ADS, and Rapier controller active.`,`ok`),requestAnimationFrame(kh)}Ah().catch(Um);